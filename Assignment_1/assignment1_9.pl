...
prime_factors_helper(N, I, [I|L]) :- is_prime(I),  N mod I =:= 0, N1 is N // I, prime_factors_helper(N1, I, L).

prime_factors_helper(N, I, L) :- I_next is I + 1, prime_factors_helper(N, I_next, L).